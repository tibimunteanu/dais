...
// API Monitor** monitorsGetAll();
// API Monitor* monitorGetPrimary();
// API void monitorGetPosition(Monitor* pMonitor, I32* out_pPosX, I32* out_pPosY);
...
// API const VideoMode* monitorGetVideoMode(Monitor* pMonitor);
// API void monitorSetGamma(Monitor* pMonitor, F32 gamma);
// API const GammaRamp* monitorGetGammaRamp(Monitor* pMonitor);
// API void monitorSetGammaRamp(Monitor* pMonitor, const GammaRamp* pGammaRamp);
// API PFN_monitorCallback monitorSetCallback(PFN_monitorCallback pfnCallback);